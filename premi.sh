...
TIMES="10"
CHATID="5023583157"
KEY="7679565859:AAG3DEgovPEbWFLhTiuhPtuidd6GowaAauU"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To SCRIPT DIMS PREMIUM STORE ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} DIMS PREMIUM STORE  ® ${NC}${YELLOW}(${NC} ${green} BAYU_XD ${NC}${YELLOW})${NC}"
echo -e " © Recode By DIMS PREMIUM STORE  ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Dimas120500/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Dimas120500/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Dimas120500/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Dimas120500/vip/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/Dimas120500/izin/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/Dimas120500/izin/main/ip | grep $MYIP | awk '{print $3}')
...
<code>────────────────────</code>
<b>   DIMS PREMIUM STORE   </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6282262299843"}]]}' 
